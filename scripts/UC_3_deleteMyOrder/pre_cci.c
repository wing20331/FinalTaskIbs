# 1 "c:\\users\\wing2\\documents\\vugen\\scripts\\uc_3_deletemyorder\\\\combined_UC_3_deleteMyOrder.c"
...
# 103 "D:\\HPLoudRunner\\include/lrun.h"
...
# 273 "D:\\HPLoudRunner\\include/lrun.h"
...
int   lr_debug_message (unsigned int msg_class,
									    char * format,
										...);
# 513 "D:\\HPLoudRunner\\include/lrun.h"
void   lr_new_prefix (int type,
                                 char * filename,
                                 int line);
# 516 "D:\\HPLoudRunner\\include/lrun.h"
...
# 540 "D:\\HPLoudRunner\\include/lrun.h"
...
int   lr_eval_string_ext (const char *in_str,
                                     ...
                                     const char *file,
								     long const line);
# 574 "D:\\HPLoudRunner\\include/lrun.h"
...
int lr_param_increment (char * dst_name,
                              char * src_name);
# 597 "D:\\HPLoudRunner\\include/lrun.h"
...
int	  lr_save_var (char *              param_val,
							  ...
							  unsigned long const options,
							  char *			  param_name);
# 621 "D:\\HPLoudRunner\\include/lrun.h"
...
# 700 "D:\\HPLoudRunner\\include/lrun.h"
...
int lr_table_get_column_name_by_index (char * param_name, int col, 
											char * * const col_name,
											size_t * col_name_len);
# 761 "D:\\HPLoudRunner\\include/lrun.h"
...
# 776 "D:\\HPLoudRunner\\include/lrun.h"
...
# 800 "D:\\HPLoudRunner\\include/lrun.h"
void   lr_param_substit_free (char * * pstr);


 
# 812 "D:\\HPLoudRunner\\include/lrun.h"
...
char *   lrfnc_eval_string (char * str,
                                      char * file_name,
                                      long const line_num);
# 820 "D:\\HPLoudRunner\\include/lrun.h"
...
int   lrfnc_save_string ( const char * param_val,
                                     ...
                                     long const line_num);
# 826 "D:\\HPLoudRunner\\include/lrun.h"
...
# 929 "D:\\HPLoudRunner\\include/lrun.h"
...
int   lr_save_value (char * param_val,
                                ...
                                char * file_name,
                                long const line_num);
# 936 "D:\\HPLoudRunner\\include/lrun.h"
...
int   lr_set_debug_message (unsigned int msg_class,
                                       unsigned int swtch);
# 958 "D:\\HPLoudRunner\\include/lrun.h"
...
# 1034 "D:\\HPLoudRunner\\include/lrun.h"
...
# 1063 "D:\\HPLoudRunner\\include/lrun.h"


# 1075 "D:\\HPLoudRunner\\include/lrun.h"
...
# 1 "c:\\users\\wing2\\documents\\vugen\\scripts\\uc_3_deletemyorder\\\\combined_UC_3_deleteMyOrder.c" 2
...
# 100 "D:\\HPLoudRunner\\include/SharedParameter.h"
...
# 2 "c:\\users\\wing2\\documents\\vugen\\scripts\\uc_3_deletemyorder\\\\combined_UC_3_deleteMyOrder.c" 2
...
# 1 "D:\\HPLoudRunner\\include/web_api.h" 1
...
# 1 "D:\\HPLoudRunner\\include/as_web.h" 1
...
# 789 "D:\\HPLoudRunner\\include/as_web.h"


# 802 "D:\\HPLoudRunner\\include/as_web.h"
...
# 840 "D:\\HPLoudRunner\\include/as_web.h"
...
# 908 "D:\\HPLoudRunner\\include/as_web.h"
...
# 9 "D:\\HPLoudRunner\\include/web_api.h" 2
...
char WebSocketReceive0[] = "{\"messageType\":\"hello\",\"uaid\":\"b445ec13a4204d87a0dc83176cea842c\",\"statu"
...
# 3 "c:\\users\\wing2\\documents\\vugen\\scripts\\uc_3_deletemyorder\\\\combined_UC_3_deleteMyOrder.c" 2
...
# 4 "c:\\users\\wing2\\documents\\vugen\\scripts\\uc_3_deletemyorder\\\\combined_UC_3_deleteMyOrder.c" 2
...
Action()
{
	...
	lr_start_transaction("MyOrder");

	web_add_cookie("_ga_TBPYED8WSW=GS1.1.1710496105.1.1.1710496151.0.0.0; DOMAIN=www.advantageonlineshopping.com");
	...
	web_url("559529690_2", 
		"URL=https://www.advantageonlineshopping.com/order/api/v1/orders/history/lines/users/{UserID}", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://www.advantageonlineshopping.com/", 
	...
	trigger = atoi(lr_eval_string("{order}"));

	

	
	web_url("MyOrders-page.html", 
		"URL=https://www.advantageonlineshopping.com/app/account/views/MyOrders-page.html", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://www.advantageonlineshopping.com/", 
	...
	if(trigger!=0){
		...
		web_reg_find("Text=OrderNumber\":{order},","Fail=Found",
		"LAST");

	
	web_custom_request("remove", 
		"URL=https://www.advantageonlineshopping.com/order/api/v1/orders/history/users/{UserID}/{order}", 
		"Method=DELETE", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
	...
	lr_end_transaction("Uc_3_delete", 2);


	return 0;
}
# 5 "c:\\users\\wing2\\documents\\vugen\\scripts\\uc_3_deletemyorder\\\\combined_UC_3_deleteMyOrder.c" 2
...
# 6 "c:\\users\\wing2\\documents\\vugen\\scripts\\uc_3_deletemyorder\\\\combined_UC_3_deleteMyOrder.c" 2
